        ...
        <div class="mx-auto max-w-[1344px]">
            @if($this->services->count() > 0)
                <div class="grid border border-charcoal/10 md:grid-cols-3 reveal">
                    ...
                    <article wire:key="service-{{ $service->id }}" class="group flex min-h-[480px] flex-col {{ !$loop->last ? 'border-b border-charcoal/10 md:border-b-0 md:border-r' : '' }} bg-cream p-8 ease-premium hover:bg-mint lg:p-10">
                        ...
                        <div class="mt-auto pt-8">
                            ...
                            <a href="{{ route('services.show', $service->slug) }}" wire:navigate class="mt-5 inline-flex items-center border-b-2 border-charcoal pb-1 text-xs font-black uppercase tracking-widest ease-premium group-hover:border-charcoal">
