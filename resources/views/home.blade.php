        ...
        <div class="mx-auto grid w-full max-w-[1344px] items-center gap-12 lg:grid-cols-12">
            <div class="relative z-10 lg:col-span-7">
                ...
                <div class="mt-10 max-w-md reveal">
                    ...
                    <a href="{{ route('services.index') }}" class="mt-8 inline-flex items-center gap-3 border-b-2 border-mint pb-2 text-sm font-black uppercase tracking-wide ease-premium hover:gap-5">
            ...
            <div class="relative mt-2 lg:col-span-5 lg:mt-20">
                ...
                <div class="bounce-slow absolute -bottom-8 -left-8 flex h-32 w-32 flex-col items-center justify-center rounded-full bg-mint text-center shadow-xl sm:h-40 sm:w-40">
                    ...
                    <span class="mt-2 text-[10px] font-black tracking-[0.2em]">{{ $services->count() }} PAKET<br>BERSIH</span>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="layanan" class="bg-cream-alt px-6 py-24 lg:px-12 lg:py-32">
        <div class="mx-auto max-w-[1344px]">
            ...
            <div class="grid border border-charcoal/10 md:grid-cols-3 reveal">
                ...
                <article class="group flex min-h-[420px] flex-col {{ !$loop->last ? 'border-b border-charcoal/10 md:border-b-0 md:border-r' : '' }} bg-cream p-8 ease-premium hover:bg-mint lg:p-10">
                    ...
                    <div class="mt-auto">
                        ...
                        <a href="{{ route('services.show', $service->slug) }}" class="mt-5 inline-flex border-b-2 border-charcoal pb-1 text-xs font-black uppercase tracking-widest ease-premium group-hover:border-charcoal">
    ...
    <section class="bg-cream-alt px-6 py-24 lg:px-12 lg:py-32">
        <div class="mx-auto max-w-[1344px]">
            ...
            <div class="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-4 reveal">
                ...
                <article class="border-l-4 border-transparent bg-cream p-7 shadow-sm ease-premium hover:-translate-y-2 hover:border-mint">
