...
<head>
    ...
    <title>403 - Akses Ditolak | BersihinAja</title>
...
<body class="min-h-screen flex items-center justify-center bg-base-200">
    <div class="text-center px-6">
        <div class="float-animation mb-6">
            <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto h-24 w-24 text-warning" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                <path stroke-linecap="round" stroke-linejoin="round" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636" />
            </svg>
        </div>
        <h1 class="text-9xl font-extrabold error-code">403</h1>
        <h2 class="text-3xl font-bold mt-4 text-base-content">Akses Ditolak</h2>
